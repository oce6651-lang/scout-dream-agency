...
export const Route = createFileRoute("/_game/jogo/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Seu escritório, jogadores, propostas e finanças." },
  ...
  return (
    ...
    >
      ...
      <div className="mb-6 grid grid-cols-3 gap-3">
        <KpiCard label="Saldo" value={`R$ ${save.empresario.dinheiro.toLocaleString("pt-BR")}`} accent />
        <KpiCard
          label="Prestígio"
          value={`${save.empresario.prestigio} · Nv ${save.empresario.nivel}`}
        />
